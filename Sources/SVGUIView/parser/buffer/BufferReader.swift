...
extension UInt8 {
  fileprivate static var _space: UInt8 { UInt8(ascii: " ") }
  fileprivate static var _return: UInt8 { UInt8(ascii: "\r") }
  fileprivate static var _newline: UInt8 { UInt8(ascii: "\n") }
  fileprivate static var _tab: UInt8 { UInt8(ascii: "\t") }
}
...
extension UInt8 {
  ...
  var isNonPrintable: Bool {
    self <= UInt8(ascii: "\u{0008}") || self == UInt8(ascii: "\u{000b}") || (self >= UInt8(ascii: "\u{000e}") && self <= UInt8(ascii: "\u{001f}")) || self == UInt8(ascii: "\u{007f}")
  }
